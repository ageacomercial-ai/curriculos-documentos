    ...
    modal.innerHTML =
      '<div style="background:#fff;border-radius:16px;padding:28px 24px;max-width:380px;width:100%;box-shadow:0 20px 60px rgba(0,0,0,0.2);animation:slideUp 0.3s ease">' +
        '<div style="text-align:center;margin-bottom:20px">' +
          ...
          '<h2 style="font-family:\'Playfair Display\',serif;font-size:20px;color:#1a2332;margin:0 0 4px">Desbloquear PDF</h2>' +
          '<p style="color:#7f8c8d;font-size:14px;margin:0">Exporta o teu documento sem marcas de água</p>' +
        '</div>' +
        '<div style="background:#f8f6f3;border-radius:12px;padding:16px;margin-bottom:16px">' +
          ...
          '<div style="text-align:center">' +
            ...
            '<div style="font-family:monospace;font-size:22px;font-weight:700;letter-spacing:4px;color:#1a2332;background:#fff;padding:10px;border-radius:8px;border:2px dashed #c9a96e">' + ref + '</div>' +
          '</div>' +
        '</div>' +
        '<div style="background:#fef9e7;border-radius:8px;padding:10px 12px;margin-bottom:16px;font-size:12px;color:#7f8c8d;display:flex;align-items:start;gap:8px">' +
          ...
          '<span>Paga numa caixa Multicaixa Express ou app do teu banco usando esta referência. Após o pagamento, usa o código de activação na secção Planos.</span>' +
        '</div>' +
        '<div style="display:flex;flex-direction:column;gap:8px">' +
          '<button id="btn-pay-confirm" style="width:100%;padding:14px;background:#1a2332;color:#fff;border:none;border-radius:12px;font-size:16px;font-weight:600;cursor:pointer">Ver Planos</button>' +
          '<button id="btn-pay-cancel" style="width:100%;padding:10px;background:none;color:#7f8c8d;border:none;border-radius:12px;font-size:14px;cursor:pointer">Voltar à pré-visualização</button>' +
        '</div>' +
      '</div>';
